...
public class SSHJFra3 extends Fragment {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    Notification notification = builder.setContentTitle("通知").setContentText("当前光照强度:" + aFloat).setSmallIcon(R.drawable.icon103).setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher)).setWhen(1000).build();
                    NotificationManager systemService = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
                    systemService.notify(3, notification);
                    break;
                case 2:
                    break;
            }
    ...
    private void initData() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                String get_$Pm25126 = sshjFra_sp.getString("getLightIntensity", "");
