...
public class SHZSFraXia2 extends Fragment {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (floats.size() == 0) {
                        ...
                        title.setText("过去1分钟最高气温:" + max + "℃,最低气温:" + min + "℃");
                    }
                    break;
                default:
                    break;
    ...
    private void initData() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                strings.clear();
                floats.clear();
                String getTemperature = shzsFra_sp.getString("getTemperature", "");
                String[] split = getTemperature.split("-");
