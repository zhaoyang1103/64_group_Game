...
public class SHZSFraXia3 extends Fragment {
    ...
    private void initData() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                strings.clear();
                floats.clear();
                String getHumidity = shzsFra_sp.getString("getHumidity", "");
                String[] split = getHumidity.split("-");
