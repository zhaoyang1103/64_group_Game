...
public class SSHJFra1 extends Fragment {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    Notification notification = builder.setContentTitle("通知").setContentText("当前PM2.5:" + aFloat).setSmallIcon(R.drawable.icon101).setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher)).setWhen(1000).build();
    ...
    private void initData() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                String get_$Pm25126 = sshjFra_sp.getString("get_$Pm25126", "");
